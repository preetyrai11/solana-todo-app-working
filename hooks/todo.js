...
export function useTodo() {
    ...
    return { initialized, initializeUser, loading, transactionPending, completedTodos, incompleteTodos, markStaticTodo, removeStaticTodo, addTodo, input, setInput, handleChange, addTodo }
}
